describe('Nittro.DI.Container', function () {
    ...
    beforeAll(function () {
        ...
        _context.register(TestClass, '__Test.Nittro.DI.Container.TestClass');

        testInstance = new Container({
            params: {
                param1: 'value1',
                param2: {
                    subparam1: 'subvalue1',
            ...
            services: {
                testService: '__Test.Nittro.DI.Container.TestClass(%param2.subparam1%, %param2.subparam2%)'
            },
            factories: {
                testFactory1: '__Test.Nittro.DI.Container.TestClass("splat")',
    ...
    it('should implement the Nittro.DI.Container mixin', function () {
        for (var method in ContainerMixin) {
            if (ContainerMixin.hasOwnProperty(method) && typeof ContainerMixin[method] === 'function') {
                expect(Container.prototype[method]).toEqual(jasmine.any(Function));
    ...
    describe('addFactory()', function () {
        it('should add the specified factory to the instance', function () {
            testInstance.addFactory('testFactory3', '__Test.Nittro.DI.Container.TestClass(baz: "splurt")');
